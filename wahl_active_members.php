...
if (isset($_POST["refresh"])) {
    refresh_active_memebers($_POST["value"]);
}
        ...
        <div class="card mx-auto vert_center" style="width: 18rem; vertical-align: middle;">
            ...
            <div style="width: 200px; padding-top: 10px;" class="mx-auto">
                ...
                while ($zeile = mysqli_fetch_array($db_erg_entry, MYSQLI_ASSOC)) {
                    ...
                    echo '<p> Aktueller Wert: <br> ' . $zeile["active_mem"] . ' stimmenberechtigte Mitglieder';
                }

                ?>
            </div>
            <div class="card-body">
                <form action="wahl_active_members.php" method="post">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Anzahl stimmberechtiger Mitglieder eingeben:</label>
                        <div class="form-group">
                            <input type="text" class="form-control" id="exampleInputEmail1" name="value" aria-describedby="emailHelp" placeholder="">
                            </select>
                        </div>
                        <button type="submit" name="refresh" class="btn btn-primary">Aktualisieren</button>
                </form>
            </div>
        </div>
